...
null, n, arguments.length > 1, null, !1))
    ...
    v.event = {
        add : function (e, n, r, i, s) {
            ...
            return;
            r.handler && (d = r, r = d.handler, s = d.selector), r.guid || (r.guid = v.guid++), a = o.events, a || (o.events = a = {
        ...
        dispatch : function (n) {
            ...
            for (r = 0;r < w.length && !n.isPropagationStopped();r++) {
                ...
                for (i = 0;i < a.matches.length && !n.isImmediatePropagationStopped();i++) {
                    ...
                    n.data = c.data, n.handleObj = c, o = ((v.event.special[c.origType] || 
                    {
...
!u && n.isLocal && !n.crossDomain ? u = c.text ? 200 : 404 : u === 1223 && (u = 204)
    ...
    var qn, Rn, Un = /^(?:toggle|show|hide)$/, zn = new RegExp("^(?:([-+])=|)(" + m + ")([a-z%]*)$", "i"), Wn = /queueHooks$/, Xn = [Gn], Vn = {
        "*" : [function (e, t) {var n, r, i = this.createTween(e, t), s = zn.exec(t), o = i.cur(), u =  + o || 0, a = 1, f = 20;if (s) {n =  + s[2], r = s[3] || (v.cssNumber[e] ? "" : "px");if (r !== "px" && u) {u = v.css(i.elem, e, !0) || n || 1;do a = a || ".5", u /=a,v.style(i.elem,e,u+r);while(a!==(a=i.cur()/ o) && a !== 1 && --f)
                }
    ...
    v.each(["toggle", "show", "hide"], function (e, t) {
        ...
        stop : function (e, n, r) {
            ...
            return typeof e != "string" && (r = n, n = e, e = t), n && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                ...
                for (n = s.length;n--;)
                s[n].elem === this && (e == null || s[n].queue === e) && (s[n].anim.stop(r), t = !1, s.splice(n, 1));(t || !r) && v.dequeue(this, e)
            })
        }
    }), v.each( {
